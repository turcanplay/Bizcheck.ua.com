...
export const BLOCK_EXPLANATIONS: BlockExplanation[] = [
  ...
  ────────────────────────────────────────────────────── */
  {
    ...
    action: {
      uk: [
        ...
        'Якщо в компанії є більш чутливі процеси (наприклад, відеоспостереження, обробка контактних або біометричних даних), украй важливо провести оцінку ризиків, оформити її документально й підготувати повний комплект необхідних документів. Це дасть змогу заздалегідь закрити вразливості й уникнути негативних наслідків. У протилежному випадку настає адміністративна відповідальність за статтею 188-39 Кодексу України про адміністративні правопорушення: за недодержання порядку захисту персональних даних, що призвело до незаконного доступу до них, на посадових осіб і громадян-підприємців накладається штраф від 300 до 1000 неоподатковуваних мінімумів доходів громадян – це від 5 100 до 17 000 гривень, а за повторне протягом року порушення – від 1000 до 2000 мінімумів, тобто від 17 000 до 34 000 гривень. Скажемо чесно: самі суми невеликі й лякати ними Вас немає сенсу. Дорожче обходиться інше – перевірка й припис Уповноваженого Верховної Ради України з прав людини, претензії клієнтів і співробітників, зупинка процесів та репутаційні втрати. До того ж у Верховній Раді опрацьовується новий закон про захист персональних даних, наближений до європейського GDPR, тож із часом і вимоги, і відповідальність стануть суттєво жорсткішими.',
      ],
      en: [
        ...
        'If the company has more sensitive processes (for example, video surveillance, or processing of contact or biometric data), it is essential to conduct a risk assessment, document it, and prepare a complete set of the necessary documents. This lets you close vulnerabilities in advance and avoid negative consequences. Otherwise, administrative liability applies under Article 188-39 of the Code of Ukraine on Administrative Offences: failure to observe the established procedure for protecting personal data, where it has led to unlawful access to that data, carries a fine on officials and citizen-entrepreneurs of 300 to 1,000 tax-free minimum incomes – that is, UAH 5,100 to 17,000 – and, for a repeat offence within a year, 1,000 to 2,000 minimums, i.e. UAH 17,000 to 34,000. To be honest: these amounts are small in themselves, and there is no point in using them to scare you. What costs more is everything else – an inspection and an order from the Ukrainian Parliament Commissioner for Human Rights, claims from clients and employees, stalled processes, and reputational damage. On top of that, a new personal data protection law aligned with the European GDPR is being worked on in the Verkhovna Rada, so over time both the requirements and the liability will become substantially stricter.',
      ],
    },
    regulatory: {
      uk: {
  ...
  ────────────────────────────────────────────────────── */
  {
    ...
    risk: {
      uk: [
        ...
        'В українських реаліях це особливо помітно: наш бізнес працює в середовищі, де складні періоди повторюються регулярно, тому договір варто розглядати не просто як документ, а як інструмент стійкості компанії. Кожен новий стресовий період швидко показує, що саме в компанії оформлено по-справжньому, а що трималося «на довірі», «на словах» чи «якось потім розберемося».',
        ...
        'Особливо варто враховувати, що договір може просто не працювати, бо застарів і не враховує актуальні норми права, які в Україні змінюються досить часто.',
      ...
      en: [
        ...
        'In Ukrainian conditions this is especially noticeable: our businesses operate in an environment where difficult periods recur regularly, so a contract is worth treating not merely as a document, but as a tool of corporate resilience. Each new stressful period quickly reveals what the company has genuinely put in order and what was held together "on trust," "on someone’s word," or "we’ll sort it out somehow later."',
        ...
        'It is especially worth keeping in mind that a contract may simply not work because it is outdated and does not reflect current legal norms, which change quite frequently in Ukraine.',
    ...
    regulatory: {
      uk: {
        label: 'Цивільний кодекс України № 435-IV',
  ...
  ────────────────────────────────────────────────────── */
  {
    ...
    risk: {
      ...
      en: [
        ...
        'A separate risk signal is regular handling of cash. In our reality this is almost always a sensitive zone, because cash is precisely what most often raises questions with the bank, the State Tax Service of Ukraine, and the State Financial Monitoring Service of Ukraine (SFMS). If the company regularly withdraws money but does not analyze why and in what volume it happens, it looks like a non-transparent financial model.',
    ...
    regulatory: {
      uk: {
        label: 'Податковий кодекс України № 2755-VI',
  ...
  ────────────────────────────────────────────────────── */
  {
    ...
    regulatory: {
      uk: {
        label: 'Кодекс України з процедур банкрутства № 2597-VIII',
        url: 'https://zakon.rada.gov.ua/laws/show/2597-19',
      },
      en: {
        label: 'Bankruptcy Procedures Code of Ukraine No. 2597-VIII',
        url: 'https://zakon.rada.gov.ua/laws/show/2597-19',
      },
    },
  },
  ...
  ────────────────────────────────────────────────────── */
  {
    ...
    risk: {
      uk: [
        ...
        'Друга чутлива зона – угоди з бізнесом: купівля компанії, часток або об’єднання. Багато хто сприймає це як звичайну комерційну угоду, але закон установлює чіткі пороги, після яких вмикається обов’язковий контроль з боку Антимонопольного комітету України (АМКУ).',
        'Порогів насправді два, і достатньо потрапити хоча б в один із них. Перший: сукупна вартість активів або обсяг реалізації товарів усіх учасників угоди – з урахуванням пов’язаних компаній і показників за кордоном – перевищує еквівалент 30 мільйонів євро, і при цьому щонайменше у двох учасників такі показники в Україні перевищують еквівалент 4 мільйонів євро в кожного. Другий: показники в Україні хоча б одного учасника угоди перевищують еквівалент 8 мільйонів євро, а обсяг реалізації товарів хоча б одного іншого учасника – в Україні або за кордоном – перевищує еквівалент 150 мільйонів євро. Якщо угода підпадає під будь-який із цих варіантів, дозвіл АМКУ потрібно одержати ще до її здійснення.',
        'При цьому концентрацією вважається не лише сам факт передавання бізнесу. Це і злиття чи приєднання компаній, і набуття контролю – через придбання активів у вигляді цілісного майнового комплексу, придбання часток або акцій, що дають вирішальний вплив, чи призначення керівництва, – а також створення нової компанії двома чи більше учасниками.',
      ...
      en: [
        ...
        'The second sensitive zone is business transactions: buying a company, shares, or a merger. Many treat this as an ordinary commercial deal, but the law sets clear thresholds beyond which mandatory review by the Antimonopoly Committee of Ukraine (AMCU) kicks in.',
        'There are in fact two thresholds, and meeting just one of them is enough. The first: the combined value of assets or volume of sales of all parties to the deal – counting related companies and figures earned abroad – exceeds the equivalent of EUR 30 million, while at least two of the parties each exceed the equivalent of EUR 4 million on those same figures in Ukraine. The second: the figures in Ukraine of at least one party to the deal exceed the equivalent of EUR 8 million, while the sales volume of at least one other party – in Ukraine or abroad – exceeds the equivalent of EUR 150 million. If the deal falls under either option, AMCU clearance must be obtained before it is carried out.',
        'And a concentration means more than the mere fact of a business changing hands. It also covers mergers and the absorption of one company by another, the acquisition of control – through buying assets as a single integral property complex, acquiring shares or stakes that confer decisive influence, or appointing management – as well as the creation of a new company by two or more parties.',
    ...
    action: {
      uk: [
        ...
        'Якщо йдеться про купівлю бізнесу, часток або об’єднання компаній, має сенс заздалегідь перевірити, чи підпадає угода під пороги, за яких потрібен дозвіл АМКУ. Це не складна перевірка, але вона може зекономити багато грошей і нервів.',
      ...
      en: [
        ...
        'If it concerns buying a business, shares, or merging companies, it makes sense to check in advance whether the deal crosses the thresholds that require AMCU clearance. This is not a difficult check, but it can save a lot of money and nerves.',
