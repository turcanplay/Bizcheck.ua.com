...
const DEFAULT_DESC_UK = 'Bizcheck.md — онлайн-платформа самодіагностики ризиків бізнесу за методологією Crowe. Тести за блоками, детальний звіт PDF, юридичні шаблони для МСБ Молдови.';
const DEFAULT_DESC_EN = 'Bizcheck.md — an online platform for self-assessing business risks using the Crowe methodology. Block-based tests, a detailed PDF report and legal templates for SMEs in Moldova.';
