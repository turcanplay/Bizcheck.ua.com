...
export default function CheckoutPage() {
  ...
  return (
    <div style={{ maxWidth: 560, margin: '80px auto', padding: 24, textAlign: 'center' }} data-page="checkout">
      <Link to="/" style={{ color: '#0A3A6E', textDecoration: 'none' }}>← Înapoi la landing</Link>
      <h1 style={{ marginTop: 12 }}>💳 Plată securizată</h1>
      <p style={{ color: '#555' }}>
        Tip: <b>{kind}</b> · Element: <b>{slug}</b>
      </p>
      <div style={{ marginTop: 32, padding: 24, background: '#FFF3D6', border: '1px solid #F5A800', borderRadius: 12 }}>
