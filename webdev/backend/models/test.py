...
class Test:
    @staticmethod
    def create(slug, name_ro, name_ru, description_ro="", description_ru="",
        ...
        return execute(
            """INSERT INTO tests (slug, name_ro, name_ru, description_ro, description_ru,
               ...
               RETURNING *""",
            (slug, name_ro, name_ru, description_ro, description_ru,
    ...
    @staticmethod
    def update(test_id, slug, name_ro, name_ru, description_ro, description_ru,
        ...
        return execute(
            """UPDATE tests
               SET slug = %s, name_ro = %s, name_ru = %s,
