...
class Template:
    @staticmethod
    def create(slug, title_uk, title_ru, description_uk="", description_ru="",
        ...
        return execute(
            """INSERT INTO templates (slug, title_uk, title_ru, description_uk, description_ru,
                                      is_active, is_coming_soon, is_paid, price, currency, category, features)
               VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s::jsonb)
               RETURNING *""",
            (slug, title_uk, title_ru, description_uk, description_ru,
    ...
    @staticmethod
    def update(template_id, slug, title_uk, title_ru, description_uk, description_ru,
               is_active, is_paid=False, price=None, currency="MDL",
               category=None, features=None, is_coming_soon=False):
        ft = _prep_json(features)
        return execute(
            """UPDATE templates
               SET slug = %s, title_uk = %s, title_ru = %s,
